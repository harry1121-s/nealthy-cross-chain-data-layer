...
contract DeployChainBScript is Script, Test {
    ...
    function _deployContracts() internal {
        ...
        // lzModule_dst = new LzModule(lzEndpoint_dst);
        // whModule_dst = new WormholeModule(whRelayer_dst);
    ...
    function _getAddresses() internal view {
        console.log("--NDL DESTINATION CHAIN ADDRESSES--");
        // console.log("LzModule -------------------------- ", address(lzModule_dst));
        // console.log("WhModule -------------------------- ", address(whModule_dst));
        // console.log("Router ---------------------------- ", address(router_dst));
        console.log("UA --------------------------------", address(counter_dst));
